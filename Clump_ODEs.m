function dydt = Clump_ODEs(t, y, params)
...
dydt(1) = (Rb .* B) .* (Ab .* Y + Gb) ./ (Ab .* Y + Gb + kb .* D) .* ...
    (1 - ((B + Lb) ./ Kb) - (Cy .* (Y + Ly) ./ Ky)) - (Delb .* B ./ Kb) -...
    Rl .* (B .* Y) ./ (B + Y) - (Rl .* (L .* B) ./ (L + B)); 
dydt(2) = (Ry .* Y) .* (Ay .* B + Gy) ./ (Ay .* B + Gy + ky .* D) .* ...
    (1 - ((Y + Ly) ./ Ky) - (Cb .* (B + Lb) ./ Kb)) - (Dely .* Y ./ Ky) -...
    Rl .* (B .* Y) ./ (B + Y) - (Rl .* (L .* Y) ./ (L + Y));
...
%     GamC .* L;
dydt(3) = ((Rly .* T) .* (Ay .* B + Gy) ./ (Ay .* B + Gy + ky .* D) .* ...
    (1 - ((Y+Ly) ./ Ky) - (Cb .* (B+Lb) ./ Kb))) - (Dely .* (T) ./ Ky) +...
    Cit * Gam .* ((B./Cher) .* ((Y-T)./Cit)) ./ (B./Cher + Y./Cit) +...
    Cit * GamL .* ((Lb./Cher) .* ((Ly-T)./Cit)) ./ (Lb./Cher + Ly./Cit);
